import { Avatar, AvatarFallback, AvatarImage, Badge, Button, Card, Checkbox, Separator, Tabs, TabsContent, TabsList, TabsTrigger } from "@/src/components/ui";
        ...
        <div className="w-full h-screen flex items-center justify-center">
            <main className="w-120 h-240 bg-white rounded-lg shadow-xs">
                <Tabs defaultValue="tasks" className="w-full">
                    ...
                    <TabsContent value="tasks" className="flex flex-col p-6 gap-6 bg-neutral-50 rounded-lg">
